...
function get_set_all_class(cls,output){
  ...
  tb=btn("button","phone","view_of(tablet)","","");
 // get_set_all_class("rf2-t1",tb);
 get_set_all_class("content-area",display_space);
  //get_set_all_class("lf1-container",display_space);
  // tb=btn("button","phone","view_of(phone)","","");
  //get_set_all_class("main_body",tb);
  /*re st*/
  /*re ed*/
  //iframe display
  function display(){
